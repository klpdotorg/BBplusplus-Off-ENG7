...
Game.appLoginEditScreen.prototype = {
	...
	create: function (game) {
		...
		_this.basePath = cordova.file.externalRootDirectory + "Android/data/com.akshara.BBplusplusOffEngG7/Files/Download/.gameFilesBB++V10_2/www/";
	...
	checkIfAllAssetsPresent: function () {
		if (_this.counter < _this.fileCheck.length) {
			...
			window.baseUrl = cordova.file.externalRootDirectory + "Android/data/com.akshara.BBplusplusOffEngG7/Files/Download/.gameFilesBB++V10_2/www/";//cordova.file.externalDataDirectory + 
			...
			fileTransfer.onprogress = function (progressEvent) {
				if (progressEvent.lengthComputable) {
					...
					if (filename == _this.user.language + "/EnglishquestionSounds.zip") {
							console.log("EnglishquestionSounds");
							_this.noOfAssets.text = "1/5";
						}
